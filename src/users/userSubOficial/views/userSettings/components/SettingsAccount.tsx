    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
        ...
        <div className="flex justify-end max-sm:flex-col max-sm:gap-4">
          <Link to={`/structure/${idStructure}`} className="px-4 max-md:w-full py-2 text-center bg-gray-200 text-gray-700 rounded-md mr-2">Cancel</Link>
          <button disabled={isSubmit} className="px-4 max-md:w-full disabled:bg-blue-400 disabled:cursor-not-allowed py-2 bg-blue-600 text-white rounded-md">
            {isSubmit ? (
              <>
